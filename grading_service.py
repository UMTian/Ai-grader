...
GRADING GUIDELINES:
1. Be STRICT and precise in your evaluation - only award marks when requirements are clearly met
2. If a criterion mentions "code" and there is NO CODE in the submission, award 0 marks for that criterion
3. If a criterion mentions specific content (like "syntax", "logic", "implementation") and that content is missing, award 0 marks
4. Check each custom criterion individually and verify the requirement exists in the submission
5. Award partial credit only when partial work is clearly visible
6. Be constructive but honest in your feedback about what is missing
7. In the criteria_scores section, explain why marks were or were not awarded for each criterion

STRICT VALIDATION RULES:
- Code-related criteria: ONLY award marks if actual code is present
- Content-specific criteria: ONLY award marks if the specific content type is found
- Quality criteria: ONLY award marks if you can identify and evaluate the quality aspect
- Completeness criteria: ONLY award marks if the work demonstrates completion
